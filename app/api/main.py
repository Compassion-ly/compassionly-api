...
from app.api.routes.topics import topics, topic_category, user_topic_rating
...
api_router.include_router(topic_category.router, prefix="/topics", tags=["topics-category"])
